                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Terms and Agreement</span></li>
                            </ol>
                        </nav>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <h5 style="text-align: center;">Terms and Agreement</h>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="widget-content widget-content-area " >
                                <form action="" method="post">
                                    <div class="form-group mb-4">
                                        <label class="">Terms<span class="text-danger">*</span></label>
                                        <input type="text" name="description" class="form-control" placeholder="Ex. xyz Company abc Ltd." value="<?php echo $inv->description; ?>" required />
                                    </div>
