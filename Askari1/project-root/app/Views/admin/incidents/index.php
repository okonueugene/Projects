                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Incident Reports</span></li>
                            </ol>
                        </nav>
                ...
                <div class="row layout-top-spacing">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-12 mb-2">
                        <div class="widget-content-area">
                            <div class="widget-one justify-content-end">
                                <a href="<?php echo base_url(); ?>admin/incident/create" class="btn btn-primary btn-rounded">Add New Incident</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php foreach ($incidents as $product) {?>
                                        <tr>
                                            <td>INC-<?php echo $product->id; ?></td>
                                            <td><?php echo $product->refno ?></td>
                                            <td><?php echo $product->title; ?></td>
                                            <td><?php echo date('d/m/Y',strtotime($product->date)); ?></td>
                                            <td><?php echo $product->time; ?></td>
                                            <td><?php echo $this->db->where('id',$product->reported_by)->get('guards')->row()->name; ?></td>
                                            <td class="text-center">
                                                <!-- <form method="DELETE" action="<?php echo base_url('incident/delete/' . $product->id); ?>">
                                                    <a class="btn btn-info" href="<?php echo base_url('incident/show/' . $product->id) ?>"> show</a>
                                                    <a class="btn btn-primary" href="<?php echo base_url('incident/edit/' . $product->id) ?>"> Edit</a>
                                                    <button type="submit" class="btn btn-danger"> Delete</button>
                                                </form> -->
                                                <a href="<?php echo base_url('incident/show/' . $product->id) ?>" class="btn btn-primary btn-rounded btn-sm">View</a>
                                            </td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
