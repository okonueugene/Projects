...
<head>
    ...
    <link href="<?php echo base_url(); ?>/theme/dark/plugins/apex/apexcharts.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url(); ?>/theme/dark/assets/css/dashboard/dash_2.css" rel="stylesheet" type="text/css" />
...
<body>
            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                        ...
                        <div class="widget widget-account-invoice-two">
                            <div class="widget-content">
                                <div class="account-box">
                                    <div class="info">
                                        <h5 class="">Yearly License</h5>
                                        <p class="inv-balance">Expires 12/12/2021</p>
                                    </div>
                                ...
                                <div class="vistorsBrowser">
                                    <div class="browser-list">
                                        ...
                                        <div class="w-browser-details">
                                            <div class="w-browser-info">
                                                <h6>Total Checkpoints</h6>
                                                <p class="browser-count"><?php echo $this->db->get('locations')->num_rows();?></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="browser-list">
                                        ...
                                        <div class="w-browser-details">
                                            ...
                                            <div class="w-browser-info">
                                                <h6>Total Rounds</h6>
                                                <p class="browser-count"><?php echo $this->db->get('rounds')->num_rows();?></p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="browser-list">
                                        <div style="background-color: white;" class="w-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="red" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x-circle">
                                                <circle cx="12" cy="12" r="10"></circle>
                                        ...
                                        <div class="w-browser-details">
                                            ...
                                            <div class="w-browser-info">
                                                <h6>Monthly Missed Checkpoints</h6>
                                                <p class="browser-count"><?php echo $this->db->where('MONTH(created_at)',date('m'))->where('time',null)->get('history')->num_rows();?></p>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                        <div class="widget widget-five">
                            <div class="widget-content">
                                    ...
                                    <div class="task-action">
                                        <div class="dropdown  custom-dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="pendingTask">
                                                <a class="dropdown-item" href="<?php echo base_url(); ?>admin/add_guards">Add</a>
                                                <a class="dropdown-item" href="<?php echo base_url(); ?>admin/rounds">View</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="w-content">
                                    <div class="">
                                        <p class="task-left"><?php echo $this->db->get('rounds')->num_rows();?></p>
                                        <p class="task-completed"><span>Rounds</span></p>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-card-two">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="<?php echo base_url();?>/theme/dark/assets/img/askarisystems.jpg" alt="avatar">
                                    </div>
                                    <div class="media-body">
                                        <h6>Site Name: </h6>
                                        <p class="meta-date-time">X X X</p>
                                    </div>
                                </div>

                                <div class="card-bottom-section">
                                    <h5><?php echo $this->db->get('guards')->num_rows();?> Guards On Site</h5>
                                    <a href="<?php echo base_url();?>admin/guards" class="btn">View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget">
                            <div class="widget-content">
                                <img src="<?php echo base_url(); ?>/theme/dark/assets/img/lovel.webp" width="100%" alt="">
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?php echo base_url(); ?>/theme/dark/plugins/apex/apexcharts.min.js"></script>
    <script src="<?php echo base_url(); ?>/theme/dark/assets/js/dashboard/dash_2.js"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    <!-- tables -->
