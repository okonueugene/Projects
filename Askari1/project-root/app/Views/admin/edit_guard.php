                                        ...
                                        <div class="row">
                                            <div class="col-xl-2 col-lg-12 col-md-4">
                                                <div class="upload mt-4 pr-md-4">
                                                    <input type="file" id="input-file-max-fs" class="dropify" data-default-file="<?php echo $inv->profilepic; ?>" data-max-file-size="2M" />
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="name" value="<?php echo $inv->name; ?>"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="guard_id" value="<?php echo $inv->guard_id; ?>" class="form-control" id="id"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="agency" value="<?php echo $inv->agency; ?>" class="form-control" id="site"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" class="form-control" value="<?php echo $inv->email; ?>"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="mobile" value="<?php echo $inv->mobile; ?>" class="form-control" id="id"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="start" class="form-control" placeholder="" value="<?php echo $inv->start; ?>"
                                                        required />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="end" class="form-control" placeholder="" value="<?php echo $inv->end; ?>"
                                                        required />
                                                </div>
                                            </div>
                                            ...
                                            <div style="text-align:center;" class="col-md-12">
                                                <div class="form-group">
                                                    <input type="submit" name="submit" class="mt-2 mb-4 btn btn-primary"
                                                        value="Update Guard Info" id="sub">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
