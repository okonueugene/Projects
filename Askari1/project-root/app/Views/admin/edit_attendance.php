...
<head>
    ...
    <link href="<?php echo base_url();?>/theme/dark/plugins/flatpickr/flatpickr.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>/theme/dark/assets/css/scrollspyNav.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url();?>/theme/dark/plugins/flatpickr/custom-flatpickr.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>/theme/dark/plugins/noUiSlider/custom-nouiSlider.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>/theme/dark/plugins/bootstrap-range-Slider/bootstrap-slider.css" rel="stylesheet" type="text/css">
...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
            ...
            <div class="layout-px-spacing">
                <div class="account-settings-container layout-top-spacing">
                    ...
                    <?php  if(isset($error)){ echo $error; }
                            ...
                            <div class="info">
                                <h6 class="text-center">Update Attendance</h6>
                                <div class="row mb-2">
                                    <div class="col-md-12 mx-auto">
                                        <p>Date:  <?php echo $inv->intime; ?> </p>
                                        <p>Guard Name: <?php echo $this->db->where('id', $inv->guard_id)->get('guards')->row()->name; ?></p>
                                        <p>Shift Timing: <?php echo date('h:i A', strtotime($this->db->where('id', $inv->guard_id)->get('guards')->row()->start)) . "<b>-</b>" . date('h:i A', strtotime($this->db->where('id', $inv->guard_id)->get('guards')->row()->end)); ?></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 mx-auto">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form action="" method="post" style="font-size:initial">
                                                    <div class="form-group mb-2">
                                                        <label for="shiftstart">In Time (Current: <?php echo date('h:i A', strtotime($inv->intime)); ?>)<span class="text-danger">*</span></label>
                                                        <input id="dateTimeFlatpickr" name="intime" value="<?php echo $inv->intime; ?>" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date..">
                                                        <input type="hidden" name="id" value="<?php echo $inv->id; ?>">
                                                        <div style="text-align:center;" class="col-md-12">
                                                            <div class="form-group">
                                                                <input type="submit" name="submit" class="mt-2 mb-4 btn btn-primary"
                                                                    value="Update intime" id="sub">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                            ...
                                            <div class="col-md-6">
                                                <form action="" method="post" style="font-size:initial">
                                                    <div class="form-group mb-2">
                                                        <label for="shiftstart">Outtime Time (Current: <?php echo date('h:i A', strtotime($inv->outtime)); ?>)<span class="text-danger">*</span></label>
                                                        <input id="dateTimeFlatpickr" name="outtime" value="<?php echo $inv->outtime; ?>" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date..">
                                                        
                                                    </div>
                                                    <div style="text-align:center;" class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="submit" name="outtime" class="mt-2 mb-4 btn btn-primary"
                                                            value="Update Outtime" id="sub">
                                                        </div>
                                                    </div>    
                                                </form>
                                            </div>
    ...
    <script src="<?php echo base_url();?>/theme/dark/plugins/flatpickr/flatpickr.js"></script>
    ...
    <script src="<?php echo base_url();?>/theme/dark/assets/js/scrollspyNav.js"></script>
    <script src="<?php echo base_url();?>/theme/dark/plugins/flatpickr/flatpickr.js"></script>
    <script src="<?php echo base_url();?>/theme/dark/plugins/noUiSlider/nouislider.min.js"></script>

    <script src="<?php echo base_url();?>/theme/dark/plugins/flatpickr/custom-flatpickr.js"></script>
    <script src="<?php echo base_url();?>/theme/dark/plugins/noUiSlider/custom-nouiSlider.js"></script>
    <script src="<?php echo base_url();?>/theme/dark/plugins/bootstrap-range-Slider/bootstrap-rangeSlider.js"></script>
    </script>
