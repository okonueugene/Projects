                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Round Details</span></li>
                            </ol>
                        </nav>
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form action="" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="info">
                                            <h5 style="text-align:center;" class="">Round Details</h5>
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="guard_id" required disabled="disabled"
                                                                    class="form-control">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="round_name"
                                                                    value="<?php echo $inv->round_name?>"
                                                                    class="form-control" placeholder=" Round Name"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="time" name="end"
                                                                    value="<?php echo $inv->end?>" class="form-control"
                                                                    placeholder="" required disabled="disabled" />
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="button" class="btn "
                                                                style="background-color:#00887a; color:white;display:none"
                                                                name="add" value="Add" id='btn_in'
                                                        ...
                                                        <div style="text-align:center;" class="col-md-12">
                                                            <div class="form-group">
                                                                <input type="submit" class="btn "
                                                                    style="background-color:#00887a; color:white; width:120px;display:none"
