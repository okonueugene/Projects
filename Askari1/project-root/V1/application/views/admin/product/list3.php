                                           ...
                                           <?php foreach($products as $product){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo $product->price; ?></td>
                                                 <td><?php echo "<img src='".$product->pro_img."' width='30px' height='30px'>"; ?></td>
                                                    
                                               
                                                <td class="text-center"><div class="btn-group">
                                                        <?php echo anchor('admin/edit_product/'.$product->id, '<i class="fa fa-edit"></i>', array("class"=>"btn btn-success")); ?>
                                                        <?php echo anchor('admin/delete_product/'.$product->id, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
