                                           ...
                                           <?php foreach($products as $product){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo $product->mobile; ?></td>
                                                 <td><?php echo $product->bussiness_name; ?></td>
                                                  <td><?php echo $product->place; ?></td>
                                                  <td><?php echo $product->closing_bal; ?></td>
                                                   <td><?php echo $product->emi_bal; ?></td>
                                                    
                                               
                                                <td class="text-center"><div class="btn-group">
                                                        <?php echo anchor('admin/edit_supplier/'.$product->id, '<i class="fa fa-edit"></i>', array("class"=>"btn btn-success")); ?>
                                                        <?php echo anchor('admin/delete_supplier/'.$product->id, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
