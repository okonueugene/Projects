                            ...
                            <div class="box box-primary">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label class="">Opening Balance<span class="text-danger">*</span></label>
                                            <input type="number" step="00.01" name="balance" class="form-control" placeholder="00.00" required/>
                                        </div>
                                         <div >
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <input type="submit" class="btn " name="submit" value="Save" id="save" style="display:none;width:200px; background-color:#00887a; color:white" />
                                ...
                                <!-- form start -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="text" name="qty" id='qty' class="form-control" placeholder="0.0" required />
