...
Add Rounds
                ...
                <section class="content">
                    <div class="row">
                            ...
                            <div class="box box-primary">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" style="font-size:initial">
                                    <div class="box-body">
                                       ...
                                       <!-- </div> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="round_name" class="form-control" placeholder=" Round Name" required />
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn " style="background-color:#00887a; color:white;display:none; width:120px;" name="submit" value="Save" id="save"/>
                        ...
                        <div class="col-xs-6" style="font-size:initial">
                           <?php  if(isset($error)){ echo $error; }
                                    echo $this->session->flashdata('message'); 
