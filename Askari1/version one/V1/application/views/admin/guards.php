                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">All Guards</h3>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo date('h:i A',strtotime($product->start)); ?></td>
                                                 <td><?php echo date('h:i A',strtotime($product->end)); ?></td>
                                                   ...
                                                   <td><?php if($product->status=='1'){echo "Active";}else{echo "Suspended";} ?></td>
                                                    
                                               
                                                <td class="text-center"><div class="btn-group">
                                                        <?php echo anchor('admin/edit_guard/'.$product->id, '<i class="fa fa-edit"></i>', array("class"=>"btn btn-success")); ?>
                                                       <?php
                                                       if($product->status=='1')
                                                       {
                                                       ?>
                                                        <?php echo anchor('admin/suspend_guard/'.$product->id, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure to Suspend?')")); ?>
                                                        <?php
                                                       }else{
                                                           ?>
                                                           
                                                           <?php echo anchor('admin/active_guard/'.$product->id, '<i class="fa fa-check"></i>', array("class"=>"btn btn-info", "onclick"=>"return confirm('Are you sure to Active?')")); ?>
                                                           <?php
                                                       }
                                                        ?>
