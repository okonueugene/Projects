                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $product->user_phone; ?></td>
                                                 <td><?php echo $product->address; ?></td>
                                                   <!--<td><?php if( $product->user_status==1){echo "<label class='text-success'>Active</label>";}else if($product->status==0){echo "<label class='text-danger'>Suspended</label>";} ?></td>-->
                                                    
                                               
                                                <td class="text-center"><div class="btn-group">
                                                        <?php echo anchor('admin/edit_user/'.$product->user_id, '<i class="fa fa-edit"></i>', array("class"=>"btn btn-success")); ?>
                                                        <?php echo anchor('admin/delete_user/'.$product->user_id, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
