...
<html>
  <head>
    ...
    <![endif]-->
     <style>
        .box.box-primary {
    border-top-color: #2b9fd2;
}
 .f{font-size:large;}
        .f2{font-size:initial;}
    </style>
  </head>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <table class="table data_table row-border table-bordered table-striped f2" style="background-color:white">
                <thead>
                 <tr>                       
                                                  <th>Date & Time</th>
                                                <th >User</th>
                                          ...
                                          $products=$this->db->get('logs')->result();
                                           foreach($products as $product){
                                            ...
                                            <tr  style="background-color:#f7e9e9">
                                                ...
                                                <td><?php if($product->user_id!=null){echo $this->db->where('user_id',$product->user_id)->get('users')->row()->user_name;}else{echo "Anonymous";} ?></td>
                                                <td><?php echo $product->ip_address; ?></td>
                                                <td><?php echo $product->agent_type; ?></td>
                                                 <td><?php echo $product->platform; ?></td>
                                                <td><?php echo "Login Failed"; ?></td>
                                            </tr>
                                             <?php }else{?>
                                            <tr >
                                            <td ><?php echo date('d/m/Y h:i A',strtotime($product->time)); ?></td>
