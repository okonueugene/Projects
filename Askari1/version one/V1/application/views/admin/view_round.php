...
$(document).ready(function(){
    $("#show").load("<?php echo  base_url().'/admin/get_sub_data2';?>");
                            ...
                            <div class="box box-primary">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="box-body">
                                       ...
                                       <!-- </div> -->
                                        <div class="form-group">
                                            ...
                                            <select name="guard_id" required class="form-control" disabled="disabled" >
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" name="round_name" value="<?php echo $inv->round_name?>" class="form-control" placeholder=" Round Name" required disabled="disabled"  />
                                        </div>
                                        <div class="form-group">
                                            <label class="">Start Time<span class="text-danger">*</span></label>
                                            <input type="time" name="start" value="<?php echo $inv->start?>" class="form-control" placeholder="" required  disabled="disabled" />
                                        </div>
                                         <div class="form-group">
                                            <label class="">End Time<span class="text-danger">*</span></label>
                                            <input type="time" name="end" value="<?php echo $inv->end?>" class="form-control" placeholder="" required disabled="disabled"  />
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn " style="background-color:#00887a; color:white; width:120px;display:none" name="submit" value="Save" id="save" />
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="button" class="btn " style="background-color:#00887a; color:white;display:none" name="add" value="Add"  id='btn_in' onclick="document.getElementById('save').style.display='block'"/>
                                    <br>
                                    <br>
