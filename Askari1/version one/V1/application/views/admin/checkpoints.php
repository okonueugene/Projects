                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">All checkpoints</h3>
                                           ...
                                           <?php foreach($products as $product){ ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><div class="btn-group">
                                                        <?php echo anchor('admin/edit_checkpoint/'.$product->id, '<i class="fa fa-edit"></i>', array("class"=>"btn btn-success")); ?>
                                                       
                                                        <?php echo anchor('admin/delete_checkpoint/'.$product->id, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure to Delete?')")); ?>
