        ...
        <section class="content">
          ...
          <table class="table data_table row-border  "  style="background-color:white; font-size:initial">
                <thead>
                 <tr>
                                                ...
                                                <th style="text-align:center">Shift Timing</th>
          ...
          <?php 
                                        ...
                                        //   $products=$this->db->get('cust_transactions')->result();
                                           foreach($products as $product){
                                            ...
                                            <tr  style="background-color:#d03323; color:white">
                                                <td class="text-center"><?php echo date('d/m/Y',strtotime($product->created_at)); ?></td>
                                                ...
                                                <td><?php echo "N/A"; ?></td>
                                                   ...
                                                   <td style=" text-align:center"><?php if($product->intime==null){echo "<i class='fa fa-times' ></i> Absent";}else{echo "<i class='fa fa-check' ></i> Present";} ?></td>
                                     ...
                                     <tr  >
                                                ...
                                                <td><?php if(empty($product->outtime)){echo "N/A";}else{echo date('h:i A',strtotime($product->outtime));} ?></td>
