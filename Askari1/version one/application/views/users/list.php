...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/theme/dark/assets/css/forms/switches.css">
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <?php foreach($users as $user){
                                        ...
                                        <tr>
                                            ...
                                            <div class="btn-group">
                                                <label class="switch s-icons s-outline s-outline-default mr-2" for='cb_<?php echo $user->user_id; ?>'>
                                                    <input data-table="users" data-status="user_status" data-idfield="user_id"  data-id="<?php echo $user->user_id; ?>" id='cb_<?php echo $user->user_id; ?>' type='checkbox' <?php echo ($user->user_status==1)? "checked" : ""; ?> />
                                                    <span class="slider round"></span>
                                                </label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <a href="<?php echo site_url("users/edit_user/".$user->user_id); ?>" class="btn btn-outline-success mb-2 btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
                                                <a href="<?php echo site_url("users/delete_user/".$user->user_id); ?>" class="btn btn-outline-danger mb-2 btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="red" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x-octagon"><polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2"></polygon><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    } ?>
