...
<head>
    ...
    <link href="<?php echo base_url();?>/theme/dark/assets/css/authentication/form-1.css" rel="stylesheet" type="text/css" />
...
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class=""><a href="<?php echo base_url();?>/askari/ ?>"><span class="brand-name"><?php echo $this->config->item('company_title');  ?></span></a></h1>
                            ...
                            <div class="form">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    ...
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary" value=""><?php echo $this->lang->line('Sign In')?></button>
                                    </div>
                                ...
                                <div class="field-wrapper">
                                    <a href="<?php echo base_url();?>/admin/sendmail" class="forgot-pass-link">Forgot Password?</a>
                                </div>

                            </div>
                        </form>                        
                        <p class="terms-conditions">By using this platform, you agree to our <a href="<?php echo base_url(); ?>admin/policy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>.</p>
    ...
    <script src="<?php echo base_url();?>/theme/dark/assets/js/authentication/form-1.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
