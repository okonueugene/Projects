...
Mitech_Kirki::add_field( 'theme', array(
	...
	'description' => esc_html__( 'Controls the site layout.', 'mitech' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'default'     => 'wide',
	'choices'     => array(
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'label'       => esc_html__( 'Site Width', 'mitech' ),
	'description' => esc_html__( 'Controls the overall site width. Enter value including any valid CSS unit. For e.g: 1200px.', 'mitech' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'default'     => '1200px',
) );
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="big_title">' . esc_html__( 'Boxed Mode Background', 'mitech' ) . '</div>',
) );
