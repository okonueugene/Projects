...
Mitech_Kirki::add_field( 'theme', array(
	...
	'label'    => esc_html__( 'Search Form', 'mitech' ),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'text',
			'element'  => '.header-01 .header-social-networks a',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'text',
			'element'  => '.header-01 .header-social-networks a:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '0 10px 15px rgba(0, 0, 0, 0.05)',
	'output'      => array(
		array(
			'element'  => '.header-01 .page-header-inner',
			'property' => 'box-shadow',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'choice'   => 'hover',
			'element'  => '.header-01 .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
			'suffix'   => '!important',
		),
	),
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-01 .header-button',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-01 .header-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
