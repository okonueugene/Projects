...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'text',
			'element'  => '.header-07 .header-social-networks a',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'text',
			'element'  => '.header-07 .header-social-networks a:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'element'  => '.header-07.headroom--top .page-header-inner',
			'property' => 'margin-top',
			'units'    => 'px',
		),
	),
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'choice'   => 'hover',
			'element'  => '.header-07 .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
			'suffix'   => '!important',
		),
	),
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'border',
			'element'  => '.header-07 .menu--primary .menu__container > li > a > .menu-item-wrap:after',
			'property' => 'background-color',
		),
		array(
			'choice'   => 'default',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'MITECH_DEMO_BUTTON_TEXT' ) ? MITECH_DEMO_BUTTON_TEXT : '',
) );
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'MITECH_DEMO_BUTTON_LINK' ) ? MITECH_DEMO_BUTTON_LINK : '',
) );
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'MITECH_DEMO_BUTTON_LINK_TARGET' ) ? MITECH_DEMO_BUTTON_LINK_TARGET : '0',
	'choices'  => array(
		'0' => esc_html__( 'No', 'mitech' ),
		'1' => esc_html__( 'Yes', 'mitech' ),
	),
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-07 .header-button',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-07 .header-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
