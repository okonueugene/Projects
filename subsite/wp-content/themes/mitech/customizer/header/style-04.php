...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'text',
			'element'  => '.header-04 .header-social-networks a',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'text',
			'element'  => '.header-04 .header-social-networks a:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-04 .header-info .info-icon',
			'property' => 'color',
		),
	),
) );
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '0 2px 26px rgba(51, 51, 51, 0.05)',
	'output'      => array(
		array(
			'element'  => '.header-04 .page-header-inner',
			'property' => 'box-shadow',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'choice'   => 'hover',
			'element'  => '.header-04 .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
			'suffix'   => '!important',
		),
	),
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-04 .header-button',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-04 .header-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
