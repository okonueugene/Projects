...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'text',
			'element'  => '.header-02 .header-social-networks a',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'text',
			'element'  => '.header-02 .header-social-networks a:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'choice'   => 'hover',
			'element'  => '.header-02 .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
			'suffix'   => '!important',
		),
	),
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-02 .header-button',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-02 .header-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
