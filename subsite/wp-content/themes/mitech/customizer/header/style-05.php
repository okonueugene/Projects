...
Mitech_Kirki::add_field( 'theme', array(
	'type'     => 'radio-buttonset',
	'settings' => $prefix . 'search_form_enable',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'text',
			'element'  => '.header-05 .header-social-networks a',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'text',
			'element'  => '.header-05 .header-social-networks a:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'default'      => array(
		...
		array(
			...
			'icon_class' => 'fa fa-comment-alt-lines',
		),
	),
	'fields'       => array(
		'title'      => array(
		...
		'sub_title'  => array(
			'type'    => 'text',
			'label'   => esc_html__( 'Sub Title', 'mitech' ),
			'default' => '',
		),
		'icon_class' => array(
			'type'    => 'text',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'label'       => esc_html__( 'Info List Icon Color', 'mitech' ),
	'description' => esc_html__( 'Controls the color of info list icon.', 'mitech' ),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	...
	'output'      => array(
		array(
			'element'  => '.header-05 .header-info .info-icon',
			'property' => 'color',
		),
	),
) );
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'choice'   => 'hover',
			'element'  => '.header-05 .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
			'suffix'   => '!important',
		),
	),
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'label'       => esc_html__( 'Search Form Color', 'mitech' ),
	'description' => esc_html__( 'Controls the color of search form.', 'mitech' ),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'choices'     => array(
		'color'      => esc_attr__( 'Color', 'mitech' ),
		'background' => esc_attr__( 'Background', 'mitech' ),
		'icon'       => esc_attr__( 'Icon', 'mitech' ),
	),
	'default'     => array(
		'color'      => '#fff',
		'background' => 'rgba(0, 47, 166, 0.3)',
		'icon'       => '#fff',
	),
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-05 .header-bottom .search-field',
			'property' => 'color',
			'suffix'   => '!important',
		),
		array(
			'choice'   => 'color',
			'element'  => '.header-05 .header-bottom .search-field:-webkit-autofill',
			'property' => '-webkit-text-fill-color',
			'suffix'   => '!important',
		),
		array(
			'choice'   => 'background',
			'element'  => '.header-05 .header-bottom .search-form',
			'property' => 'background-color',
		),
		array(
			'choice'   => 'icon',
			'element'  => '.header-05 .header-bottom .search-submit',
			'property' => 'color',
		),
	),
) );
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'settings'    => $prefix . 'background',
	'label'       => esc_html__( 'Background', 'mitech' ),
	'description' => esc_html__( 'Controls the background of navigation.', 'mitech' ),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => array(
		'background-color'      => Mitech::PRIMARY_COLOR,
		'background-image'      => '',
		'background-repeat'     => 'no-repeat',
		'background-size'       => 'cover',
		'background-attachment' => 'scroll',
	...
	'output'      => array(
		array(
			'element' => '.header-05 .header-bottom',
		),
	),
) );
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-05 .header-button',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
...
Mitech_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-05 .header-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
