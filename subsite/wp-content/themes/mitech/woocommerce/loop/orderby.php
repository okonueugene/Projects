...
<div class="shop-filter-right col-md-6">
	<?php if ( Mitech::setting( 'shop_archive_sorting' ) === '1' ) : ?>
		<form class="woocommerce-ordering" method="get">
			<select name="orderby" class="orderby" aria-label="<?php esc_attr_e( 'Shop order', 'mitech' ); ?>">
	...
	<?php if ( Mitech::setting( 'shop_archive_style_switcher' ) === '1' ) : ?>
		<div id="shop-style-switcher" class="shop-view-switcher">
			<?php
			$switcher_grid_classes = 'switcher-item grid';
			$switcher_list_classes = 'switcher-item list';
			$shop_style            = Mitech_Woo::instance()->get_shop_archive_style();
