...
if ( ! class_exists( 'Mitech_Footer' ) ) {
	...
	class Mitech_Footer {
		...
		function get_list_footers( $default = false ) {
			$args = array(
				'post_type'      => 'ic_footer',
				'posts_per_page' => -1,
				'post_status'    => 'publish',
			...
			if ( $default === true ) {
				$results[''] = esc_html__( 'Default', 'mitech' );
			}

			$results['none'] = esc_html__( 'None', 'mitech' );
		...
		function mobile_menu_logo() {
			$mobile_logo = Mitech::setting( 'mobile_menu_logo' );
			$logo_width  = Mitech::setting( 'mobile_logo_width' );

			if ( isset( $mobile_logo['id'] ) ) {
				$logo_url = Mitech_Image::get_attachment_url_by_id( array(
					'id'   => $mobile_logo['id'],
			...
			<div id="page-off-sidebar" class="page-off-sidebar">
				<div class="inner">
					...
					<div class="page-off-sidebar-content">
						<?php Mitech_Templates::generated_sidebar( 'off_sidebar' ); ?>
					</div>
				</div>
			</div>
			<?php
			...
			<div id="page-mobile-main-menu" class="page-mobile-main-menu">
				<div class="inner">
					...
					<div class="page-mobile-menu-content">
						<?php Mitech::menu_mobile_primary(); ?>
					</div>
				</div>
			</div>
			<?php
		...
		function scroll_top() {
			?>
			<?php if ( Mitech::setting( 'scroll_top_enable' ) ) : ?>
