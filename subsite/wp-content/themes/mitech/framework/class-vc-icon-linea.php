...
if ( ! class_exists( 'Mitech_VC_Icon_Linea' ) ) {
	class Mitech_VC_Icon_Linea {
		...
		public function add_to_libraries( $list ) {
			$list = $list + array( esc_html__( 'Linea', 'mitech' ) => 'linea' );
		...
		public function vc_element_enqueue( $font ) {
			switch ( $font ) {
				case 'linea':
					wp_enqueue_style( 'font-linea', MITECH_THEME_URI . '/assets/fonts/linea/font-linea.min.css', null, null );
					break;
			}
		}
		...
		function admin_enqueue_scripts() {
			wp_enqueue_style( 'linea', MITECH_THEME_URI . '/assets/fonts/linea/font-linea.min.css', null, null );
		}
