...
class Mitech_Init {
	...
	private function __construct() {
		...
		if ( ! function_exists( '_wp_render_title_tag' ) ) {
			add_action( 'wp_head', array( $this, 'mitech_render_title' ) );
		}
	}
	...
	public function setup() {
		 ...
		 */
		load_theme_textdomain( 'mitech', MITECH_THEME_DIR . '/languages' );
	...
	function core_info( $info ) {
		$info['icon']    = MITECH_THEME_URI . '/assets/admin/images/logo.png';
		$info['tf']      = 'https://themeforest.net/item/it-solutions-mitech-technology-it-services-solutions-wordpress-theme/23629596';
		$info['docs']    = 'https://document.thememove.com/mitech';
		$info['child']   = 'https://api.thememove.com/update/mitech/mitech-child.zip';
		$info['update']  = 'https://api.thememove.com/update/mitech';
		$info['api']     = 'https://api.thememove.com/update/mitech';
		$info['support'] = 'https://thememove.ticksy.com/';
		$info['faqs']    = 'https://thememove.ticksy.com/articles/';
		$info['desc']    = esc_html__( 'Thank you for using our theme, please reward it a full five-star &#9733;&#9733;&#9733;&#9733;&#9733; rating.', 'mitech' );
