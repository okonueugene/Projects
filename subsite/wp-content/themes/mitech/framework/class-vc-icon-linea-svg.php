...
if ( ! class_exists( 'Mitech_VC_Icon_Linea_SVG' ) ) {
	class Mitech_VC_Icon_Linea_SVG {
		...
		public function add_to_libraries( $list ) {
			$list = $list + array( esc_html__( 'Linea SVG', 'mitech' ) => 'linea_svg' );
		...
		public function vc_element_enqueue( $font ) {
			switch ( $font ) {
				case 'linea_svg':
					wp_enqueue_script( 'vivus', MITECH_THEME_URI . '/assets/js/vivus.min.js', array( 'jquery' ), '0.4.4', true );
					break;
			}
		}
		...
		function admin_enqueue_scripts() {
			wp_enqueue_style( 'linea', MITECH_THEME_URI . '/assets/fonts/linea/font-linea.min.css', null, '0.4.4' );
		}

		public function add_fonts( $icons ) {
			$new_icons = array(
				esc_html__( 'Arrows & Direction', 'mitech' ) => array(
				...
				esc_html__( 'Basic Elaboration', 'mitech' )  => array(
				...
				esc_html__( 'Ecommerce', 'mitech' )          => array(
				...
				esc_html__( 'Software', 'mitech' )           => array(
				...
				esc_html__( 'Weather', 'mitech' )            => array(
