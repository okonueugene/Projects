...
$unique_id = uniqid( 'tm-tta-container-' );
mitech_vc_tta_tabs_get_inline_css( "#{$unique_id}", $atts );
$wrapper_classes = 'tm-tta-container';
$wrapper_classes .= Mitech_Helper::get_animation_classes();

$output = '<div id="' . esc_attr( $unique_id ) . '" class="' . esc_attr( $wrapper_classes ) . '">';
