...
$style      = $el_class = $items = $loop = $equal_height = $auto_play = $v_center = $h_center = $nav = $pagination = '';
$image_size = $image_size_width = $image_size_height = '';
$atts       = vc_map_get_attributes( $this->getShortcode(), $atts );
$css_id     = uniqid( 'tm-slider-client-' );
...
$css_class = 'tm-slider-client mitech-swiper tm-swiper';
