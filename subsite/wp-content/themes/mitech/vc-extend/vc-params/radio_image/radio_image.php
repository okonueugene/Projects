...
*/
if ( ! class_exists( 'Mitech_VC_Radio_Image' ) ) {
	class Mitech_VC_Radio_Image {
...
if ( class_exists( 'Mitech_VC_Radio_Image' ) ) {
	...
	function mitech_vc_image_radio_settings_field( $settings, $value ) {

		$field = new Mitech_VC_Radio_Image( $settings, $value );

		return $field->render();
	}

	WpbakeryShortcodeParams::addField( 'image_radio', 'mitech_vc_image_radio_settings_field', MITECH_THEME_URI . '/vc-extend/vc-params/radio_image/scripts.js' );
}
