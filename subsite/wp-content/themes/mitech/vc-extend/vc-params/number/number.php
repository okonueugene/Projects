 ...
 * Example
    array(
        'type'       => 'number',
        'heading'    => esc_html__( 'Number field', 'mitech' ),
...
*/
if ( ! class_exists( 'Mitech_VC_Number_Param' ) ) {

	class Mitech_VC_Number_Param {
		...
		public function __construct() {
			if ( class_exists( 'WpbakeryShortcodeParams' ) ) {
				WpbakeryShortcodeParams::addField( 'number', array(
					$this,
					'render',
				), MITECH_THEME_URI . '/vc-extend/vc-params/number/functions.js' );
			}
		}
