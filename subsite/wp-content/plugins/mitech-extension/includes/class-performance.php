...
if ( ! class_exists( 'Mitech_Performance' ) ) {
	class Mitech_Performance {
		...
		function disable_emojis() {
			$enable = Mitech::setting( 'disable_emoji' );
			if ( ! $enable ) {
				return;
			}
		...
		function disable_embeds_code_init() {
			$enable = Mitech::setting( 'disable_embeds' );
			if ( ! $enable ) {
				return;
			}
	...
	Mitech_Performance::instance()->init();
}
